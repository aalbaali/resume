...
\cvevent{ROS Software Developer - Robotics Team}{\href{https://vention.io/}{Vention}}{05/2023 -- Present}{Montreal, Canada}
Mainly responsible for \textbf{ROS}-related tasks, where the tasks include maintaining the communication between the front-end and the robotic arm, both in simulation and using the real robot and maintaining Dockerfiles.
The primary tools used in this job are \textbf{ROS}, \textbf{Python}, \textbf{JavaScript}, and \textbf{Docker}.
