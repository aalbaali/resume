...
The primary tools used in this job are \textbf{ROS}, \textbf{C++}, \textbf{Python}, computer vision, and nonlinear least squares (mainly using \href{https://github.com/ceres-solver/ceres-solver}{Ceres}).
...
\cvevent{Undergraduate Researcher Assistant}{\href{https://www.decar.ca}{\textsc{DECAR group (McGill University)}}}{09/2017 -- 05/2018}{Montreal, Canada}
